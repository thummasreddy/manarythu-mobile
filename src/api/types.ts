...
/** Detail response of GET /products/{slug} — carries the full variant list, no defaultVariant. */
export interface ProductDetail { id: string; name: LocalizedText; slug: string; description?: LocalizedText; categorySlug: string; categoryName?: LocalizedText; images?: string[]; growingMethod: GrowingMethod; organicCertified: boolean; harvestDate?: string; nextHarvestDate?: string; ratingAvg: number; ratingCount: number; farmer: FarmerSummary; variants: Variant[] }
